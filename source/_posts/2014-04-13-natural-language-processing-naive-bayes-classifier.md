...
| 成份 | 物理意義   |
|:--------------------|:----------------------------------------------------------------------------|
\mid  $$P(C )$$           \mid  在所有的文章中,  類別 $$C$$ 所占的比例, 若比例越高, 就表示文章越有可能屬於此類別 \mid 
\mid  $$P(W_{i}\mid C )$$ \mid  若某文章的類別是 $$C$$ , 則此文章有關鍵字 $$W_{i}$$ 的機率              \mid 
\mid  $$1- P(W_{i}\mid C )$$ \mid  若某文章的類別是 $$C$$ , 則此文章沒有關鍵字 $$W_{i}$$ 的機率         \mid 
